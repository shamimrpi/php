		...
		<div class="single-blog-item">
			...
			<div class="blog-item-content mt-5">
				<div class="blog-item-meta mb-3">
					<span class="text-color-2 text-capitalize mr-3"><i class="icofont-user mr-2"></i> {{$post->user->name}}</span>
				...
				<h2 class="mb-4 text-md"><a href="blog-single.html">{{$post->title}}</a></h2>
